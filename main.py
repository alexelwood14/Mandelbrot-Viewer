...
def main():
    ...
    # If it were rendered in its entirety as an image it would contain
    # 72,000,000,000,000,000,000,000,000,000,000,000 (seventy-two decillion) pixels, roughly 8192k
    double = False
