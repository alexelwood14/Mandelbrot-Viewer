...
def main():
    #Peforms all functions needed for initialisation when program is executed

    #Without double precision max zoom is x30,000
    #With double precision max zoom is x3,239,159,213,962
    #With double precision max zoom is x23,230,999,980,401
    #If it were rendered in its entirety as an image it would contain 72,000,000,000,000,000,000,000,000,000,000,000 (seventy-two decillion) pixles, roughly 8192k
    double = False
