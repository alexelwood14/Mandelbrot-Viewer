...
def initiate(resolution, fullscreen, double):
    ...
    #OpenGL and GLFW persets and shader initiation
...
def setup_buffer(render_data, vertices, surfaces):
    ...
    glVertexAttribPointer(position, 2, GL_FLOAT, GL_FALSE, render_data["data_size"] * render_data["line_length"], ctypes.c_void_p(0))
